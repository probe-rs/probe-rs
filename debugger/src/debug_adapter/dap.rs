...
/// Helper functions to validate and build command subsets from [`super::repl_commands`]].
pub(crate) mod repl_commands_helpers;
/// Various enums and structs used by the [`super::repl_commands::ReplCommand`].
...
/// [`adapter::DebugAdapter`] and the [`super::repl_commands::ReplCommand`].
