...
impl Registers {
    ...
    pub fn get_frame_pointer(&self) -> Option<u64> {
        let reg_num = self.register_description.frame_pointer().register_number.0 as u32;
    ...
    pub fn set_frame_pointer(&mut self, value: Option<u64>) {
        let register_address = self.register_description.frame_pointer().register_number.0 as u32;
    ...
    pub fn get_stack_pointer(&self) -> Option<u64> {
        let reg_num = self.register_description.stack_pointer().register_number.0 as u32;
    ...
    pub fn set_stack_pointer(&mut self, value: Option<u64>) {
        let register_address = self.register_description.stack_pointer().register_number.0 as u32;
    ...
    pub fn get_return_address(&self) -> Option<u64> {
        let reg_num = self.register_description.return_address().register_number.0 as u32;
    ...
    pub fn set_return_address(&mut self, value: Option<u64>) {
        let register_address = self.register_description.return_address().register_number.0 as u32;
