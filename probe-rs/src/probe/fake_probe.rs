...
use crate::{
    architecture::arm::{
        ...
        FullyQualifiedApAddress, ArmError, ArmProbeInterface, DapAccess, DpAddress, MemoryApInformation,
...
impl DapAccess for FakeArmInterface<Initialized> {
    ...
    fn read_raw_ap_register(&mut self, _ap: FullyQualifiedApAddress, _address: u8) -> Result<u32, ArmError> {
