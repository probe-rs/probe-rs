...
// =====================================================================
// RV32 registers (32-bit data types)
// =====================================================================
...
// =====================================================================
// RV64 registers (64-bit data types — same IDs, wider data type)
// =====================================================================
...
// =====================================================================
// RV64 register arrays
// =====================================================================

// Non-FPU registers (RV64 — same IDs as RV32 but 64-bit data type)
...
// FPU registers for RV64 with D extension (double-precision, 64-bit)
static RISCV64_WITH_FP_REGS_SET: &[CoreRegister] = &[
    // Floating point flags and rounding mode CSRs (same width as RV32)
    CoreRegister {
        roles: &[RegisterRole::Core("fflags")],
        id: RegisterId(0x001),
        data_type: RegisterDataType::UnsignedInteger(32),
    ...
    // Floating point registers f0-f31 (RV64D: 64-bit double-precision)
    CoreRegister {
        roles: &[
            RegisterRole::Core("f0"),
            RegisterRole::FloatingPoint,
