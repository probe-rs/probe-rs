...
use crate::{probe::JTAGAccess, Error as ProbeRsError, RegisterLocation};
...
pub struct RiscvCommunicationInterfaceState {
    ...
    /// abstract command
    abstract_cmd_register_info: HashMap<RegisterLocation, CoreRegisterAbstractCmdSupport>,
}
...
impl<'probe> RiscvCommunicationInterface {
    ...
    fn perform_memory_read_progbuf<V: RiscvValue32>(
        ...
        command.set_regno((register::S0).location.0 as u32);
    ...
    fn perform_memory_read_multiple_progbuf<V: RiscvValue32>(
        ...
        for word in &mut data[..data_len - 1] {
            ...
            command.set_regno((register::S1).location.0 as u32);
    ...
    pub(crate) fn abstract_cmd_register_read(
        &mut self,
        regno: impl Into<RegisterLocation>,
