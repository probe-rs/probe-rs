...
use crate::architecture::arm::{ArmNewError, ArmProbeInterface};
use crate::Error;
...
impl<'a> Dwt<'a> {
    ...
    pub fn enable(&mut self) -> Result<(), ArmNewError> {
    ...
    pub fn enable_data_trace(&mut self, unit: usize, address: u32) -> Result<(), ArmNewError> {
    ...
    pub fn disable_data_trace(&mut self, unit: usize) -> Result<(), ArmNewError> {
        let mut function = Function::load_unit(self.component, self.interface, unit)?;
    ...
    pub fn enable_exception_trace(&mut self) -> Result<(), ArmNewError> {
        let mut ctrl = Ctrl::load(self.component, self.interface)?;
    ...
    pub fn disable_exception_trace(&mut self) -> Result<(), ArmNewError> {
        let mut ctrl = Ctrl::load(self.component, self.interface)?;
