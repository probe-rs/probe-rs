...
pub(super) static ARM32_COMMON_REGS_SET: &[CoreRegister] = &[
    CoreRegister {
        name: "R0",
        roles: Some(RegisterRole::ArgumentAndResult("a1")),
        id: RegisterId(0),
        data_type: RegisterDataType::UnsignedInteger(32),
    },
    CoreRegister {
        name: "R1",
        roles: Some(RegisterRole::ArgumentAndResult("a2")),
        id: RegisterId(1),
        data_type: RegisterDataType::UnsignedInteger(32),
    },
    CoreRegister {
...
static CORTEX_M_COMMON_REGS_SET: &[CoreRegister] = &[
    CoreRegister {
        name: "MSP",
        roles: Some(RegisterRole::MainStackPointer),
        id: RegisterId(0b10001),
        data_type: RegisterDataType::UnsignedInteger(32),
    },
    CoreRegister {
        name: "PSP",
        roles: Some(RegisterRole::ProcessStackPointer),
    ...
    CoreRegister {
        name: "EXTRA",
        roles: Some(RegisterRole::Other("EXTRA")),
