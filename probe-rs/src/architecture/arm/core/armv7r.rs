//! ARMv7-R core interface (Cortex-R4, R5, R7, R8, etc.)
...
/// Interface for interacting with an ARMv7-R core (Cortex-R series)
pub struct Armv7r<'probe>(pub(crate) Armv7ar<'probe>);

impl<'probe> Armv7r<'probe> {
    pub(crate) fn new(
...
impl CoreInterface for Armv7r<'_> {
...
impl MemoryInterface for Armv7r<'_> {
