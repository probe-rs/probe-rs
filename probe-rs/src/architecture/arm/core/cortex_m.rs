...
use crate::{DebugProbeError, Error, Memory, MemoryMappedRegister, RegisterNumber};
...
pub(crate) fn read_core_reg(memory: &mut Memory, addr: RegisterNumber) -> Result<u32, Error> {
