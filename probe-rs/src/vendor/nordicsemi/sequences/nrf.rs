...
use crate::{
    architecture::arm::{
        ...
        FullyQualifiedApAddress, ArmCommunicationInterface, ArmError, ArmProbeInterface, DapAccess,
    },
...
pub trait Nrf: Sync + Send + Debug {
    ...
    fn core_aps(&self, interface: &mut dyn ArmProbe) -> Vec<(FullyQualifiedApAddress, FullyQualifiedApAddress)>;
