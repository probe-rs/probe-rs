...
use crate::architecture::arm::{
    communication_interface::Initialized, FullyQualifiedApAddress, ArmCommunicationInterface, DapAccess,
};
...
impl Nrf for Nrf9160 {
    fn core_aps(&self, memory: &mut dyn ArmProbe) -> Vec<(FullyQualifiedApAddress, FullyQualifiedApAddress)> {
