...
pub struct UpdaterChannel<I: Serialize + Send + Sync + 'static, O: Deserialize<'static> + Send + Sync + 'static> {
...
impl<I: Serialize + Send + Sync + 'static, O: Deserialize<'static> + Send + Sync + 'static> UpdaterChannel<I, O> {
