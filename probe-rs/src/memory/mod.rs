    ...
    ERR: std::error::Error + From<InvalidDataLengthError> + From<MemoryNotAlignedError>,
{
        ...
        Error: From<ERR>,
    {
        let result = match operation.operation {
            ...
            OperationKind::Write(ref data) => self.write(operation.address, data),
            OperationKind::Write8(ref data) => self.write_8(operation.address, data),
            OperationKind::Write16(ref data) => self.write_16(operation.address, data),
            OperationKind::Write32(ref data) => self.write_32(operation.address, data),
            OperationKind::Write64(ref data) => self.write_64(operation.address, data),
    ...
    pub(crate) fn reborrow(&mut self) -> Operation<'_> {
        Operation {
            ...
            operation: match self.operation {
                OperationKind::Read(ref mut data) => OperationKind::Read(&mut *data),
                OperationKind::Read8(ref mut data) => OperationKind::Read8(&mut *data),
                OperationKind::Read16(ref mut data) => OperationKind::Read16(&mut *data),
                OperationKind::Read32(ref mut data) => OperationKind::Read32(&mut *data),
                OperationKind::Read64(ref mut data) => OperationKind::Read64(&mut *data),
                OperationKind::Write(ref data) => OperationKind::Write(&*data),
                OperationKind::Write8(ref data) => OperationKind::Write8(&*data),
                OperationKind::Write16(ref data) => OperationKind::Write16(&*data),
                OperationKind::Write32(ref data) => OperationKind::Write32(&*data),
                OperationKind::Write64(ref data) => OperationKind::Write64(&*data),
