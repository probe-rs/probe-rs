...
use self::bits::{BitIter, IteratorExt};
use self::capabilities::{Capabilities, Capability};
use self::config::JlinkConfig;
use self::connection::JlinkConnection;
...
use crate::probe_drivers::usb_util::InterfaceExt;
use crate::{
    architecture::{
        arm::{
    ...
    probe::{
        ...
        JtagDriverState, ProbeCreationError, ProbeFactory, RawJtagIo, RawSwdIo, SwdSettings,
        WireProtocol,
    },
};
...
impl DebugProbe for JLink {
    ...
    fn attach(&mut self) -> Result<(), DebugProbeError> {
        ...
        if target_voltage < super::LOW_TARGET_VOLTAGE_WARNING_THRESHOLD {
            tracing::warn!(
