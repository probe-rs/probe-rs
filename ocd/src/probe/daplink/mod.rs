...
impl DAPLink {
    ...
    fn transfer_configure(&self, request: ConfigureRequest) -> Result<(), DebugProbeError> {
        use commands::Error;
        commands::send_command::<ConfigureRequest, ConfigureResponse>(
            &self.device,
            request,
        )
        .and_then(|v| match v {
    ...
    fn send_swj_sequences(&self, request: SequenceRequest) -> Result<(), DebugProbeError> {
        ...
        commands::send_command::<SequenceRequest, SequenceResponse>(
            &self.device, 
            request
        )
        .and_then(|v| match v {
...
impl DebugProbe for DAPLink {
    ...
    fn attach(&mut self, protocol: Option<WireProtocol>) -> Result<WireProtocol, DebugProbeError> {
        ...
        let result = commands::send_command(&self.device, protocol)
            .and_then(|v| match v {
