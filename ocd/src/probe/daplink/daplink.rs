...
impl DAPLink {
    ...
    fn set_swj_clock(&self, clock: u32) -> Result<(), DebugProbeError> {
        ...
        super::commands::send_command::<SWJClockRequest, SWJClockResponse>(
            &self.device,
    ...
    fn transfer_configure(&self, request: ConfigureRequest) -> Result<(), DebugProbeError> {
        use super::commands::Error;
        super::commands::send_command::<ConfigureRequest, ConfigureResponse>(
            &self.device,
            request,
        )
        .and_then(|v| match v {
    ...
    fn configure_swd(&self, request: swd::configure::ConfigureRequest) -> Result<(), DebugProbeError> {
        ...
        super::commands::send_command::<swd::configure::ConfigureRequest, swd::configure::ConfigureResponse>(
            &self.device, 
            request
        )
        .and_then(|v| match v {
    ...
    fn send_swj_sequences(&self, request: SequenceRequest) -> Result<(), DebugProbeError> {
        ...
        super::commands::send_command::<SequenceRequest, SequenceResponse>(
            &self.device, 
            request
        )
        .and_then(|v| match v {
...
impl<P: DebugPort, R: DPRegister<P>> DPAccess<P,R> for DAPLink {
    ...
    fn read_dp_register(&mut self, _port: &P) -> Result<R, Self::Error> {
        ...
        let result = self.read_register(crate::probe::debug_probe::Port::DebugPort, u16::from(R::ADDRESS))?;
    ...
    fn write_dp_register(&mut self, _port: &P, register: R) -> Result<(), Self::Error> {
        ...
        self.write_register(crate::probe::debug_probe::Port::DebugPort, u16::from(R::ADDRESS), value)
    }
...
impl DebugProbe for DAPLink {
    ...
    fn attach(&mut self, protocol: Option<WireProtocol>) -> Result<WireProtocol, DebugProbeError> {
        ...
        let result = super::commands::send_command(&self.device, protocol)
            .and_then(|v| match v {
...
impl DAPAccess for DAPLink {
    ...
    fn read_register(&mut self, port: crate::probe::debug_probe::Port, addr: u16) -> Result<u32, DebugProbeError> {
        let port = match port {
            crate::probe::debug_probe::Port::DebugPort => Port::DP,
            crate::probe::debug_probe::Port::AccessPort(_) => Port::AP,
        };

        super::commands::send_command::<TransferRequest, TransferResponse>(
            &self.device,
            TransferRequest::new(
    ...
    fn write_register(&mut self, port: crate::probe::debug_probe::Port, addr: u16, value: u32) -> Result<(), DebugProbeError> {
        let port = match port {
            crate::probe::debug_probe::Port::DebugPort => Port::DP,
            crate::probe::debug_probe::Port::AccessPort(_) => Port::AP,
        };
