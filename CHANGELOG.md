...
### Fixed
 ...
 - Fix a bug in the gdb-server that causes it to never halt after a continue
 - Fix that the gdb-server always draws 100 % core usage from the one it's running on
