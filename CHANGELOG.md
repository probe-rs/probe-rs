...
### Fixed
 ...
 - Fixed a problem with flaky flashing on MIMXRT when the firmware has
   changed the FlexRAM configuration from the POR fuse settings. (#3020) by @mciantyre
 ...
 - the progressbars are now properly reset at the right time to improve the accuracy of the speed and ETA. (#2970) by @diondokter (#2970) by @diondokter
...
[unreleased]: https://github.com/probe-rs/probe-rs/compare/v0.26.0...master
